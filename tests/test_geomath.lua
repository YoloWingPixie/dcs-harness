...
function TestGeoMath:testBearingBetween()
    local bN = BearingBetween({ x = 0, y = 0, z = 0 }, { x = 0, y = 0, z = 10 })
    lu.assertNotNil(bN)
    lu.assertAlmostEquals(bN, 0, 1e-6)
    local bE = BearingBetween({ x = 0, y = 0, z = 0 }, { x = 10, y = 0, z = 0 })
    lu.assertNotNil(bE)
    lu.assertAlmostEquals(bE, 90, 1e-6)
    local bS = BearingBetween({ x = 0, y = 0, z = 0 }, { x = 0, y = 0, z = -10 })
    lu.assertNotNil(bS)
    lu.assertAlmostEquals(bS, 180, 1e-6)
    local bW = BearingBetween({ x = 0, y = 0, z = 0 }, { x = -10, y = 0, z = 0 })
    lu.assertNotNil(bW)
...
function TestGeoMath:testNormalizeVectors()
    local n2 = NormalizeVector2D({ x = 3, y = 0, z = 4 })
    lu.assertNotNil(n2)
...
function TestGeoMath:testDotCross()
    local d2 = DotProduct2D({ x = 1, y = 0, z = 0 }, { x = 0, y = 0, z = 1 })
    lu.assertNotNil(d2)
...
function TestGeoMath:testAngleBetweenVectors2D()
    local a = AngleBetweenVectors2D({ x = 1, y = 0, z = 0 }, { x = 0, y = 0, z = 1 })
    lu.assertNotNil(a)
    lu.assertAlmostEquals(a, 90, 1e-6)
    local b = AngleBetweenVectors2D({ x = 1, y = 0, z = 0 }, { x = -1, y = 0, z = 0 })
    lu.assertNotNil(b)
