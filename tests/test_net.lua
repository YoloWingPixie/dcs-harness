...
function TestNet:setUp()
    ...
    _G.net = {
        ...
        -- Functions
        send_chat = function(message, all)
            return true
        end,
        send_chat_to = function(message, playerId, fromId)
            return true
        end,
        ...
        get_stat = function(playerId, statId)
            return statId * 10 + playerId
        end,
        is_server = function()
            return true
        end,
        ...
        load_mission = function(path)
            return true
        end,
        load_next_mission = function()
            return true
        end,
        get_mission_name = function()
            return "test_mission.miz"
        end,
        force_player_slot = function(playerId, side, slotId)
            return true
        end,
    }
end
