...
function TestTime:setUp()
    ...
    timer.getTime = function() return self.currentTime end
    timer.getAbsTime = function() return self.absTime end
    timer.getTime0 = function() return self.time0 end
end
...
function TestTime:testErrorHandling()
    ...
    timer.getTime = function() error("Timer error") end
    timer.getAbsTime = function() error("Timer error") end
    timer.getTime0 = function() error("Timer error") end
