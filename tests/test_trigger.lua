...
function TestTrigger:testLineToAll()
    ...
    lu.assertEquals(trigger.action._called[1].args[2], start)
    lu.assertEquals(trigger.action._called[1].args[3], endPos)
end
...
function TestTrigger:testCircleToAll()
    ...
    lu.assertEquals(trigger.action._called[1].args[1], 3001)
    lu.assertEquals(trigger.action._called[1].args[2], center)
    lu.assertEquals(trigger.action._called[1].args[3], 500)
end
...
function TestTrigger:testMarkupToAll()
    ...
    local result = MarkupToAll(1, -1, 5001, point1, point2, color, fillColor, 1, false, "Line Shape")
    lu.assertEquals(result, true)
    ...
    local result3 = MarkupToAll(7, 1, 5003, point1, point2, point3, point4, point5, point6, {0, .6, .6, 1}, {0.8, 0.8, 0.8, .3}, 4)
    lu.assertEquals(result3, true)
