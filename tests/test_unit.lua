...
function TestUnit:setUp()
    ...
    self.mockUnits = {
        ["Player"] = {
            ...
            getPosition = function(self) return {
                p = {x = 100, y = 50, z = 200},
                x = {x = 1, y = 0, z = 0},
                y = {x = 0, y = 1, z = 0},
                z = {x = 0, y = 0, z = 1}
            ...
            getGroup = function(self) return {getName = function() return "Aerial-1" end} end,
            getPlayerName = function(self) return "TestPlayer" end,
            getLife = function(self) return 0.8 end,
            getLife0 = function(self) return 1.0 end,
            getFuel = function(self) return 0.75 end,
            inAir = function(self) return true end,
            getAmmo = function(self) return {
                {desc = {typeName = "AIM-120C"}, count = 4},
                {desc = {typeName = "AIM-9X"}, count = 2}
            } end,
            getName = function(self) return "Player" end
        },
        ["Ground-1"] = {
            isExist = function(self) return true end,
            getPosition = function(self) return {
            ...
            getVelocity = function(self) return {x = 5, y = 0, z = 0} end,
            getTypeName = function(self) return "M1A2" end,
            getCoalition = function(self) return 2 end,
            getCountry = function(self) return 1 end,
            getGroup = function(self) return {getName = function() return "Armor-1" end} end,
            getPlayerName = function(self) return nil end,
            getLife = function(self) return 0.5 end,
            getLife0 = function(self) return 1.0 end,
            getFuel = function(self) return 0.3 end,
            inAir = function(self) return false end,
            getAmmo = function(self) return {} end,
            getName = function(self) return "Ground-1" end
        },
        ["Destroyed"] = {
            isExist = function(self) return false end,
            getPosition = function(self) error("Unit does not exist") end,
            getVelocity = function(self) error("Unit does not exist") end,
            getTypeName = function(self) return "F-16C" end,
            getName = function(self) return "Destroyed" end
        }
    }
...
function TestUnit:testUnitExists_APIError()
    self.mockUnits["ErrorUnit"] = {
        ...
        getName = function(self) return "ErrorUnit" end
    }
...
function TestUnit:testGetUnitHeading_SouthFacing()
    self.mockUnits["SouthUnit"] = {
        ...
        getName = function(self) return "SouthUnit" end
    }
...
function TestUnit:testGetUnitHeading_WestFacing()
    self.mockUnits["WestUnit"] = {
        ...
        getName = function(self) return "WestUnit" end
    }
...
function TestUnit:testGetUnitVelocity_StationaryUnit()
    self.mockUnits["Stationary"] = {
        ...
        getName = function(self) return "Stationary" end
    }
...
function TestUnit:testGetUnitVelocity_APIError()
    self.mockUnits["VelError"] = {
        isExist = function(self) return true end,
        getVelocity = function(self) error("API error") end,
        getName = function(self) return "VelError" end
    }
...
function TestUnit:testGetUnitCoalition_RedUnit()
    self.mockUnits["RedUnit"] = {
        isExist = function(self) return true end,
        getCoalition = function(self) return 1 end,
        getName = function(self) return "RedUnit" end
    }
...
function TestUnit:testGetUnitCoalition_NeutralUnit()
    self.mockUnits["NeutralUnit"] = {
        isExist = function(self) return true end,
        getCoalition = function(self) return 0 end,
        getName = function(self) return "NeutralUnit" end
    }
...
function TestUnit:testGetUnitCountry_Russia()
    self.mockUnits["RussianUnit"] = {
        ...
        getName = function(self) return "RussianUnit" end
    }
...
function TestUnit:testGetUnitPlayerName_EmptyPlayerName()
    self.mockUnits["EmptyPlayer"] = {
        isExist = function(self) return true end,
        getPlayerName = function(self) return "" end,
        getName = function(self) return "EmptyPlayer" end
    }
...
function TestUnit:testGetUnitLife_FullHealth()
    self.mockUnits["FullHealth"] = {
        ...
        getName = function(self) return "FullHealth" end
    }
...
function TestUnit:testGetUnitLife_NearDeath()
    self.mockUnits["NearDeath"] = {
        isExist = function(self) return true end,
        getLife = function(self) return 0.01 end,
        getName = function(self) return "NearDeath" end
    }
...
function TestUnit:testGetUnitLife0_NonStandardMax()
    self.mockUnits["HeavyUnit"] = {
        isExist = function(self) return true end,
        getLife0 = function(self) return 5.0 end,
        getName = function(self) return "HeavyUnit" end
    }
...
function TestUnit:testGetUnitFuel_FullTank()
    self.mockUnits["FullTank"] = {
        isExist = function(self) return true end,
        getFuel = function(self) return 1.0 end,
        getName = function(self) return "FullTank" end
    }
...
function TestUnit:testGetUnitFuel_EmptyTank()
    self.mockUnits["EmptyTank"] = {
        isExist = function(self) return true end,
        getFuel = function(self) return 0.0 end,
        getName = function(self) return "EmptyTank" end
    }
...
function TestUnit:testGetUnitFuel_ExternalTanks()
    self.mockUnits["ExternalTanks"] = {
        isExist = function(self) return true end,
        getFuel = function(self) return 1.5 end,  -- >1.0 with external tanks
        getName = function(self) return "ExternalTanks" end
    }
...
function TestUnit:testIsUnitInAir_ParkedAircraft()
    self.mockUnits["Parked"] = {
        isExist = function(self) return true end,
        inAir = function(self) return false end,
        getName = function(self) return "Parked" end
    }
...
function TestUnit:testGetUnitAmmo_PartiallyExpended()
    self.mockUnits["PartialAmmo"] = {
        ...
        getName = function(self) return "PartialAmmo" end
    }
...
function TestUnit:testUnit_NegativeLifeValue()
    self.mockUnits["NegativeLife"] = {
        isExist = function(self) return true end,
        getLife = function(self) return -0.1 end,  -- Should not happen but test anyway
        getName = function(self) return "NegativeLife" end
    }
...
function TestUnit:testUnit_VeryHighSpeed()
    self.mockUnits["Hypersonic"] = {
        isExist = function(self) return true end,
        getVelocity = function(self) return {x = 2000, y = 100, z = 500} end,
        getName = function(self) return "Hypersonic" end
    }
