...
function TestZoneSearch:setUp()
    ...
    if not env.info then env.info = function() end end
    if not env.warning then env.warning = function() end end
    if not env.error then env.error = function() end end
    ...
    self.mockUnits = {
        ...
        },
        {
            ...
            getPosition = function() return {p = {x = 100, y = 100, z = 100}} end,
            getCoalition = function() return 2 end
        },
        {
            getName = function() return "Unit3" end,
            getPosition = function() return {p = {x = 5000, y = 100, z = 5000}} end,
            getCoalition = function() return 1 end
        }
    }
